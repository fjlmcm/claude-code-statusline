...
const STRINGS = {
  en: {
    ...
    quota_5h: '5h left', quota_7d: '7d left', quota_extra: 'extra left',
    quota_before: 'by {time}',
    tasks: 'tasks',
  },
  zh: {
    ctx: '上下文', dirty: '修改', session: '会话', lines: '行变化',
    quota_5h: '5小时剩余', quota_7d: '7天剩余', quota_extra: '额外剩余',
    quota_before: '{time}前剩余',
    tasks: '任务',
  },
  ja: {
    ctx: 'コンテキスト', dirty: '変更', session: '経過', lines: '行',
    quota_5h: '5時間残り', quota_7d: '7日間残り', quota_extra: '追加残り',
    quota_before: '{time}まで',
    tasks: 'タスク',
  },
  ko: {
    ctx: '컨텍스트', dirty: '변경', session: '세션', lines: '줄',
    quota_5h: '5시간남음', quota_7d: '7일남음', quota_extra: '추가남음',
    quota_before: '{time}까지',
    tasks: '작업',
  },
  fr: {
    ctx: 'contexte', dirty: 'modif', session: 'session', lines: 'lignes',
    quota_5h: 'reste 5h', quota_7d: 'reste 7j', quota_extra: 'reste extra',
    quota_before: 'avant {time}',
    tasks: 'taches',
  },
  de: {
    ctx: 'Kontext', dirty: 'geändert', session: 'Sitzung', lines: 'Zeilen',
    quota_5h: '5h übrig', quota_7d: '7d übrig', quota_extra: 'Extra übrig',
    quota_before: 'bis {time}',
    tasks: 'Aufgaben',
  },
  es: {
    ctx: 'contexto', dirty: 'modif', session: 'sesión', lines: 'líneas',
    quota_5h: 'resta 5h', quota_7d: 'resta 7d', quota_extra: 'resta extra',
    quota_before: 'hasta {time}',
    tasks: 'tareas',
  },
  pt: {
    ctx: 'contexto', dirty: 'modif', session: 'sessão', lines: 'linhas',
    quota_5h: 'resta 5h', quota_7d: 'resta 7d', quota_extra: 'resta extra',
    quota_before: 'até {time}',
    tasks: 'tarefas',
  },
  ru: {
    ctx: 'контекст', dirty: 'изменено', session: 'сессия', lines: 'строк',
    quota_5h: 'ост. 5ч', quota_7d: 'ост. 7д', quota_extra: 'ост. доп.',
    quota_before: 'до {time}',
    tasks: 'задачи',
  },
};
